...
class Maze(tk.Tk, object):
    ...
    def _build_maze(self):
        ...
        # hell1
        hell1_center = origin + np.array([self.UNIT * 4, self.UNIT])
        self.hell1 = self.canvas.create_rectangle(
            hell1_center[0] - 15, hell1_center[1] - 15,
            hell1_center[0] + 15, hell1_center[1] + 15,
            fill='black')
        # hell2
        hell2_center = origin + np.array([self.UNIT, self.UNIT * 4])
...
class SarsaLambda(RL):
    def __init__(self, action_space, learning_rate=0.01, gamma=0.9, e_greedy=0.9, trace_decay=0.9):
        super(SarsaLambda, self).__init__(action_space, learning_rate, gamma, e_greedy)
    ...
    def learn(self, s, a, r, s_, a_):
        ...
        self.q_table += self.lr * error * self.eligibility_trace.loc[:, :]
    ...
    def check_stat_exist(self, state):
        if state not in self.q_table.index:
            ...
            self.q_table.append(to_be_append)
...
if __name__ == '__main__':
    ...
    for episode in range(1000):
        ...
        while True:
            ...
            # RL learn from this transition (s, a, r, s, a) ==> Sarsa 执行一步就更新一次q-table
